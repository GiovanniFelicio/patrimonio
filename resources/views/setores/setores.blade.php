    ...
    <div class="row">
        <div class="col-md-12">
            <div class="overview-wrap">
                <h2 class="title-1">Setores</h2>
                @if(Auth::user()->level >= 2)
                    <a href="{{route('adcSetor')}}" style="color: white" class="au-btn au-btn-icon au-btn--blue">
    ...
    <div class="row">
        <div class="col-lg-12">
			...
			<div class="table-responsive m-b-30">
                <table id="myTable" class="func display nowrap table table-borderless table-striped table-earning">
                    <thead>
                    <tr>
                        <th>Nome</th>
                        @if(Auth::user()->level >= 3)
                            <th class="text-left">Secretaria/Autarquia</th>
                        @endif
                        <th>Opções</th>
                    </tr>
                    </thead>
